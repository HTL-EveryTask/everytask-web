      ...
      >
        <Transition name="side">
          <div
            ...
            class="absolute sm:static bg-white shadow-lg sm:shadow-none transition-all duration-300 flex sm:flex-col rounded-xl max-h-[20rem] overflow-hidden"
          >
            <div
            ...
            >
              ...
              <div
                class="p-2 flex items-center hover:text-raisin hover:bg-yonder/10 rounded-r-lg cursor-pointer"
                @click="selectDaysFromToday(7 - today.getDay())"
              >
                <IconCalender class="w-5 h-5" />
                <span class="ml-1">Next Sunday</span>
              </div>
            </div>
